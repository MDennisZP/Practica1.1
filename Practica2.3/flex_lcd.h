...
#define LCD_RD7     PORTAbits.RA1       // D7 de la LCD
#define TRISRD7     TRISAbits.TRISA1

#define LCD_RD6     PORTAbits.RA2       // D6 de la LCD
#define TRISRD6     TRISAbits.TRISA2

#define LCD_RD5     PORTAbits.RA3       // D5 de la LCD
#define TRISRD5     TRISAbits.TRISA3

#define LCD_RD4     PORTAbits.RA4       // D4 de la LCD
#define TRISRD4     TRISAbits.TRISA4

#define LCD_EN      PORTCbits.RC4       // EN
#define TRISEN      TRISCbits.TRISC4

#define LCD_RS      PORTDbits.RD3       // RS
#define TRISRS      TRISDbits.TRISD3
...
void Lcd_Init(void);
void Lcd_Out(unsigned char y, unsigned char x, const char *buffer); //mensajes definidos
